...
Status: Automatically verified; manual Turkish copy review open
...
Automated evidence proves functional localization mechanics and exact expected
copy. A dated creator review of the complete Turkish wording in the actual
interface and generated artifacts remains manual acceptance rather than an
automated claim.
