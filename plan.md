...
6. [I][A] Add multiple named resume presentation versions without duplicating the shared profile.
   [I][A] Per-version Experience and Project selection is implemented. [I] Targeted description
   overrides for those two item types are implemented; broader overrides remain deferred.
